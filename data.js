...
const SKILLS = {
  ...
  hellgaze: {name:"ВЗГЛЯД",          type:"attack", power:1.3, el:"tyrant", effect:"stun", chance:0.4, cd:2, desc:"Он смотрит. Ты не двигаешься."},
  hellfire: {name:"666",             type:"attack", power:0.9, el:"curse", aoe:true, effect:"burn", chance:0.7, cd:3, desc:"Пентаграмма вспыхивает под всеми"},
...
const MOOSE_EVENT={req:15, code:"лось.exe", ids:["d160"], lvl:145, effLvl:34, lvlBonus:5, cooldown:0, reward:{gold:66600,gems:66,scrolls:66}, egg:"d158"};
