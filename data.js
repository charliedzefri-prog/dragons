...
const CHARA_MISSIONS=[
 {id:"c1", name:"Пробуждение острова", req:15, lvl:20, ids:["d19","d47"], room:"island",
  intro:"Ты просыпаешься на цветах у берега. Рядом — нож. Ты уже знаешь, что делать.", win:"Пыль. Остров стал тише.",
  pre:[["d163_battle","Чара","* Приветик. Это ты водишь мной? Забавно."],["av0","Хранитель","Кто ты такая? Откуда у тебя нож?"],["d163_battle","Чара","* Нож всегда был здесь. Просто никто не поднимал. Пошли — на острове остались те, кого ты когда-то пожалел."]],
  mid:["* Смотри, как они бегут.","* Тебе ведь тоже нравится, признайся.","* Ещё немного. Ещё чуть-чуть."],
  post:[["d163_battle","Чара","* Видишь? Легко. Они даже не поняли."],["av0","Хранитель","Это были просто новички…"],["d163_battle","Чара","* Все когда-то новички. Дальше — клиника. Там пахнет спиртом и страхом."]]},
 {id:"c2", name:"Клиника 222-666", req:15, lvl:30, ids:["d37","d49","d13"], room:"clinic",
  intro:"Белые стены. Капельницы. Кто-то смеётся за дверью палаты. Смех прекращается.", win:"Простыни красные. Тебе всё равно.",
  pre:[["d163_battle","Чара","* Клиника. Здесь лечат. Мы будем лечить по-своему."],["av0","Хранитель","Чара, стой. Зачем это всё?"],["d163_battle","Чара","* Зачем? Потому что ты нажал «продолжить». Три раза подряд, помнишь? Ты сам меня позвал."]],
  mid:["* Доктор, доктор, у меня нож.","* Не отворачивайся. Смотри.","* Их EXP теперь мой."],
  post:[["d163_battle","Чара","* 222… 666… красивые числа."],["d163_battle","Чара","* Дальше — тёмная сторона. Мистеры. Ночь. Там будет кто-то, кого ты не ждёшь."]]},
 {id:"c3", name:"Мистеры и Ночь", req:15, lvl:40, ids:["d31","d129"], room:"night",
  intro:"Ночь без звёзд. Терминалы мигают ошибками. Кто-то в чёрной короне ждёт тебя.", win:"Экраны гаснут один за другим. Осталось одно.",
  pre:[["d129","Анти-Бисквит","Ошибка. Ошибка. ТЫ — ошибка. Королева велела не пускать тебя."],["d163_battle","Чара","* Королева? Ха. Передай ей, что я скоро."],["av0","Хранитель","Какая королева? Чара, о ком он?"],["d163_battle","Чара","* …Не отвлекайся. Режь."]],
  mid:["* Глюки. Обожаю глюки.","* Стереть. Стереть. СТЕРЕТЬ.","* Ты чувствуешь? Мир становится тоньше."],
  post:[["d163_battle","Чара","* Он был всего лишь копией. Настоящее — впереди."],["av0","Хранитель","Чара. Кто такая королева?"],["d163_battle","Чара","* Скоро узнаешь. Осталась одна дверь. За ней — третий час."]]},
 {id:"c4", name:"Третий час", req:15, lvl:50, ids:["d157"], boss:true, room:"hall",
  intro:"Золотой свет часовни. Он стоит в коридоре с посохом. «Прекрасный день, не правда ли?»", win:"…ты стёрла мир. Что дальше? Ты улыбаешься.",
  pre:[["d157","Великий Джонни","Дитя. Я знаю, кто ведёт твою руку. Остановись, пока ты ещё ты."],["d163_battle","Чара","* Я — это я. А ты — просто ещё один EXP."],["d157","Великий Джонни","Тогда прости меня за то, что я сделаю."]],
  mid:["* Посох сломается. Всё ломается.","* Улыбнись, старик.","* Это конец. Твой."],
  post:[["d163_battle","Чара","* …Готово. Мир пуст. Ты помог мне его стереть."],["av0","Хранитель","Мы… закончили? Что теперь?"],["d163_battle","Чара","* Теперь? Теперь я отчитаюсь."],["d11","Бисквит","Мяу. Отличная работа, Чара. Как я и приказала."],["av0","Хранитель","БИСКВИТ?! Ты?.. Маленькая королева?"],["d11","Бисквит","Маленькая. Королева. Пока вы гонялись за Лосем и Джонни, кто-то должен был убрать лишних. Чара — мой нож. Была."],["d163_battle","Чара","* «Была»?"],["d11","Бисквит","Ножи тупятся. Спасибо за EXP, ребёнок. Хранитель — увидимся. Скоро. Мяу."],["d163_battle","Чара","* …Приветик, Бисквит. Запомни это слово. Я приду за тобой первой."]]},
];
// комнаты для прогулки Чары: фон, декор и интерактивные объекты (x,y в % комнаты)
const CHARA_ROOMS={
 island:{bg:"linear-gradient(#1b2a3a,#0b1420 60%,#08101a)",floor:"repeating-linear-gradient(90deg,#122 0 46px,#133 46px 48px)",deco:["🌴","🌸","🌸","🐚","🪨"],goal:[82,45],
  items:[{x:20,y:20,ico:"🌸",say:"* Золотые цветы. Они смягчили падение. Не твоё."},{x:45,y:70,ico:"🪵",say:"* Дневник новичка Пита: «сегодня научился кормить дракона!». * Ты вырываешь страницу."},{x:65,y:18,ico:"🥒",say:"* Огурчик. Он ничего не сделал. * Ты берёшь его с собой. На потом."},{x:30,y:50,ico:"🔪",say:"* Нож. Ты уже держишь такой. Но второй не помешает.",atk:1}]},
 clinic:{bg:"linear-gradient(#e8f0ee,#cfd8d6 70%,#9aa)",floor:"repeating-linear-gradient(0deg,#d8e0de 0 47px,#c0c8c6 47px 48px),repeating-linear-gradient(90deg,#d8e0de 0 47px,#c0c8c6 47px 48px)",dark:true,deco:["🛏️","🛏️","💉","🚪","🩸"],goal:[80,30],
  items:[{x:15,y:65,ico:"🛏️",say:"* Кровать. Тёплая. Кто-то лежал здесь минуту назад."},{x:40,y:25,ico:"📋",say:"* Карта пациента: «222-666, статус: стабилен». * Ты дописываешь: «был»."},{x:60,y:70,ico:"💊",say:"* Таблетки. Ты съедаешь горсть. * HP восстановлены. Ничего не изменилось.",heal:1},{x:35,y:80,ico:"🪞",say:"* Зеркало. В нём — не Хранитель. В нём — ты. * Ты улыбаешься."}]},
 night:{bg:"linear-gradient(#050510,#0a0020 60%,#000)",floor:"repeating-linear-gradient(90deg,#08081c 0 46px,#1a0a3a 46px 48px)",deco:["🖥️","🖥️","🌑","⚡","🖥️"],goal:[84,55],
  items:[{x:18,y:30,ico:"🖥️",say:"* Терминал: «ОШИБКА 4614. ОШИБКА 4614. КОРОЛЕВА СМОТРИТ». * Ты выключаешь его ножом."},{x:50,y:22,ico:"👑",say:"* Чёрная корона на столе. Внутри выцарапано: «Б.». * Чара молчит."},{x:40,y:72,ico:"📞",say:"* Телефон звонит. Ты берёшь трубку. «…333…333…» * Ты вешаешь."},{x:70,y:78,ico:"🕯️",say:"* Свеча. Ты гасишь её пальцами. Не больно."}]},
 hall:{bg:"linear-gradient(#3a2a05,#6a4a10 40%,#e8c060 100%)",floor:"repeating-linear-gradient(90deg,rgba(255,220,120,.12) 0 60px,rgba(0,0,0,.25) 60px 64px)",gold:true,deco:["🕯️","🕯️","🪟","🕯️","🕯️"],goal:[86,50],
  items:[{x:20,y:25,ico:"🪟",say:"* Витраж. На нём — кошка с короной. * Ты не помнишь, чтобы здесь была кошка."},{x:45,y:75,ico:"🕯️",say:"* Свечи горят золотом. Прекрасный день, не правда ли."},{x:62,y:20,ico:"📜",say:"* Записка почерком Бисквит: «Чара. После Джонни — ты свободна. Обещаю. Мяу». * Обещания кошек ничего не стоят."},{x:30,y:55,ico:"🍩",say:"* Пончик на скамье. Ты не голодна. Ты полна решимости.",heal:1}]}
};
